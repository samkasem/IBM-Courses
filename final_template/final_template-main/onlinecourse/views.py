...
def submit(request, course_id):
    ...
    for choiche_id in submitted_answers:
        submission.chocies.add(Choice.objects.get(pk=choiche_id))

    # Redirect to show_exam_result with the submission id
    #show_exam_result(request, course_id, submission.id)
...
def extract_answers(request):
    ...
    print("Submited Answer: " + str(submitted_answers))
    return submitted_answers


# Create an exam result view to check if learner passed exam and show their 
...
def show_exam_result(request, course_id, submission_id):
    ...
    choiche_list = submission.chocies.all()
